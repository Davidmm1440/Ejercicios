...
public interface SeriesService {
	...
	/**
	 * Debe eliminar la serie con el id indicado, y todas sus entidades asociadas de
	 * bbdd. Si hay algún error, lanzará SeriesServiceException.
	 */
	public void elimnarSerie(Long idSerie) throws SeriesServiceException;

	/**
	 * Actualizará la serie que se pasa por parámetro y todas las entidades
	 * asociadas que estén modificadas. Si hay algún error, lanzará
	 * SeriesServiceException
	 */
